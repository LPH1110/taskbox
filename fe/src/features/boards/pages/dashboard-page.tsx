  ...
  return (
    <div className="space-y-8 px-4 pb-8">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground">Your productivity statistics and recent activity.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col rounded-sm border bg-card p-6 text-card-foreground shadow-sm transition-all hover:border-border/80">
          <div className="flex flex-row items-center justify-between pb-2">
            <h3 className="tracking-tight text-sm font-medium text-muted-foreground">Total Tasks</h3>
        ...
        <div className="flex flex-col rounded-sm border bg-card p-6 text-card-foreground shadow-sm transition-all hover:border-border/80">
          <div className="flex flex-row items-center justify-between pb-2">
            <h3 className="tracking-tight text-sm font-medium text-muted-foreground">Active Boards</h3>
        ...
        <div className="flex flex-col rounded-sm border bg-card p-6 text-card-foreground shadow-sm transition-all hover:border-border/80">
          <div className="flex flex-row items-center justify-between pb-2">
            <h3 className="tracking-tight text-sm font-medium text-muted-foreground">Completion Rate</h3>
        ...
        <div className="flex flex-col rounded-sm border bg-card p-6 text-card-foreground shadow-sm transition-all hover:border-border/80">
          <div className="flex flex-row items-center justify-between pb-2">
            <h3 className="tracking-tight text-sm font-medium text-muted-foreground">Recent Activity</h3>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <div className="col-span-4 flex h-[400px] flex-col rounded-sm border bg-card p-6 text-card-foreground shadow-sm">
          <h3 className="font-semibold leading-none tracking-tight mb-4">Productivity Trend</h3>
        ...
        <div className="col-span-3 flex h-[400px] flex-col rounded-sm border bg-card p-6 text-card-foreground shadow-sm">
          <h3 className="font-semibold leading-none tracking-tight mb-4">Recent Actions</h3>
          <div className="flex-1 flex items-center justify-center border-t border-dashed border-border/50">
            <p className="text-sm text-muted-foreground flex items-center gap-2">
